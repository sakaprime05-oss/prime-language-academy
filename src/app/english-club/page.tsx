    ...
    <div style={{ background: "#080808", color: "#F5F0E8", fontFamily: "'Inter', sans-serif", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          <div style={{ width: 32, height: 32, borderRadius: "50%", background: "linear-gradient(135deg,#D4AF37,#A08828)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 900, color: "#080808" }}>P</div>
          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 17, color: "#F5F0E8", fontWeight: 700 }}>Prime<span style={{ color: "#D4AF37" }}>.</span></span>
        </Link>
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "110px 2rem 80px", position: "relative", overflow: "hidden" }}>
        {/* Background elements */}
        <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(212,175,55,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", inset: 0, backgroundImage: "linear-gradient(rgba(212,175,55,0.025) 1px, transparent 1px), linear-gradient(90deg, rgba(212,175,55,0.025) 1px, transparent 1px)", backgroundSize: "60px 60px", pointerEvents: "none" }} />

        <div style={{ maxWidth: 900, textAlign: "center", position: "relative", zIndex: 1 }}>
          {/* Badge */}
          <div style={{ display: "inline-flex", alignItems: "center", gap: 10, border: "1px solid rgba(212,175,55,0.3)", borderRadius: 100, padding: "8px 22px", marginBottom: 40, background: "rgba(212,175,55,0.06)" }}>
            <span style={{ fontSize: 16 }}>🔑</span>
            <span style={{ fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#D4AF37", fontWeight: 600 }}>Membership Privé · Abidjan</span>
          </div>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(3rem, 7vw, 6rem)", lineHeight: 1.05, fontWeight: 900, marginBottom: 32, letterSpacing: "-0.02em" }}>
            The English Club<br />
            <em style={{ color: "#D4AF37", fontStyle: "italic" }}>by Prime Academy</em>
          </h1>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
            {["Networking", "100% Anglais", "Niveau B2 → C2", "Abidjan", "Global Mindset"].map(t => (
              <span key={t} style={{ fontSize: 11, color: "rgba(245,240,232,0.35)", border: "1px solid rgba(212,175,55,0.12)", borderRadius: 100, padding: "5px 14px", letterSpacing: "0.1em", textTransform: "uppercase" }}>{t}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "100px 2rem", background: "rgba(212,175,55,0.02)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#D4AF37", marginBottom: 16 }}>Deux offres distinctes</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
            ...
            {/* Club */}
            <div style={{ border: "1px solid #D4AF37", borderRadius: 24, padding: "48px 40px", background: "rgba(212,175,55,0.04)", backdropFilter: "blur(16px)", boxShadow: "0 0 40px rgba(212,175,55,0.1), inset 0 0 40px rgba(212,175,55,0.03)", position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", top: -60, right: -60, width: 200, height: 200, borderRadius: "50%", background: "rgba(212,175,55,0.06)", filter: "blur(60px)", pointerEvents: "none" }} />
              <div style={{ fontSize: 11, color: "#D4AF37", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 20 }}>Parcours 02 · Exclusif</div>
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 900, color: "#D4AF37", marginBottom: 16 }}>English Club</h3>
              ...
              <div style={{ fontSize: 11, color: "#D4AF37", opacity: 0.7, textTransform: "uppercase", letterSpacing: "0.12em" }}>Accès direct si niveau B2+ · Ou après Formation</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="activites" style={{ padding: "100px 2rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ marginBottom: 64 }}>
            <div style={{ fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#D4AF37", marginBottom: 16 }}>Programme</div>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 900, margin: 0 }}>
              Ce qui vous attend<br /><em style={{ color: "#D4AF37" }}>au Club</em>
            </h2>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
            {ACTIVITIES.map(({ icon, tag, title, desc }) => (
              <div key={title} style={{ border: "1px solid rgba(212,175,55,0.12)", borderRadius: 20, padding: "36px 28px", background: "rgba(20,20,30,0.6)", backdropFilter: "blur(16px)", transition: "all 0.3s" }}
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
                  ...
                  <span style={{ fontSize: 10, color: "#D4AF37", border: "1px solid rgba(212,175,55,0.3)", borderRadius: 100, padding: "4px 12px", letterSpacing: "0.15em", textTransform: "uppercase" }}>{tag}</span>
                </div>
      ...
      {/* ── AMBIANCE ── */}
      <section style={{ padding: "80px 2rem", background: "rgba(212,175,55,0.02)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.8rem,3.5vw,2.8rem)", fontWeight: 900, marginBottom: 20 }}>
            L'ambiance ? <em style={{ color: "#D4AF37" }}>Chaleureuse et exigeante.</em>
          </h2>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 32, flexWrap: "wrap" }}>
            {[["🌍", "Global Mindset"], ["🤝", "Bienveillance"], ["⚡", "Exigence"], ["🎯", "100% Anglais"], ["🥂", "Lifestyle"]].map(([icon, label]) => (
              <div key={label} style={{ textAlign: "center" }}>
                ...
                <div style={{ fontSize: 11, color: "#D4AF37", letterSpacing: "0.15em", textTransform: "uppercase" }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "100px 2rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#D4AF37", marginBottom: 16 }}>Membership</div>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 900, margin: "0 0 12px" }}>
              Choisissez votre <em style={{ color: "#D4AF37" }}>niveau d'engagement</em>
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(165px, 1fr))", gap: 16 }}>
            {MEMBERSHIPS.map(p => (
              <div key={p.id} style={{
                border: p.top ? "1px solid #D4AF37" : "1px solid rgba(212,175,55,0.12)",
                borderRadius: 20, padding: "30px 20px",
                background: p.top ? "rgba(212,175,55,0.07)" : "rgba(20,20,30,0.6)",
                backdropFilter: "blur(16px)",
                boxShadow: p.top ? "0 0 30px rgba(212,175,55,0.12)" : "none",
                position: "relative", textAlign: "center",
              }}>
                {p.top && <div style={{ position: "absolute", top: -12, left: "50%", transform: "translateX(-50%)", background: "#D4AF37", color: "#080808", fontSize: 9, fontWeight: 800, padding: "4px 14px", borderRadius: 100, textTransform: "uppercase", letterSpacing: "0.15em", whiteSpace: "nowrap" }}>Le Plus Exclusif</div>}
                <div style={{ fontSize: 12, fontWeight: 700, color: p.top ? "#D4AF37" : "rgba(245,240,232,0.8)", marginBottom: 6 }}>{p.label}</div>
                <div style={{ fontSize: 10, color: "rgba(245,240,232,0.35)", marginBottom: 24, letterSpacing: "0.08em" }}>{p.freq}</div>
                <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 24, fontWeight: 900, color: p.top ? "#D4AF37" : "#F5F0E8" }}>{p.price}</div>
          ...
          <div style={{ textAlign: "center", marginTop: 48 }}>
            <Link href="/register-club" style={{
              ...
              boxShadow: "0 0 35px rgba(212,175,55,0.25)", display: "inline-block",
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 12 }}>
            {[
              ...
              <span key={p} style={{ border: "1px solid rgba(212,175,55,0.2)", borderRadius: 100, padding: "10px 20px", fontSize: 13, color: "rgba(245,240,232,0.65)" }}>{p}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ borderTop: "1px solid rgba(212,175,55,0.1)", padding: "40px 2rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 20 }}>
