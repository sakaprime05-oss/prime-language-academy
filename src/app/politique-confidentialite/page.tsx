        ...
        <main className="min-h-screen bg-[var(--background)] px-6 py-24 text-[var(--foreground)]">
            <article className="mx-auto max-w-3xl space-y-8">
                ...
                <header>
                    ...
                    <p className="mt-4 text-[var(--foreground)]/55">Cette page explique comment les données des apprenants sont utilisées dans le cadre de l'inscription et du suivi pédagogique.</p>
                </header>
