        ...
        return (
            <div className="space-y-6 animate-in fade-in duration-500 pb-12">
                ...
                <div className="glass-card bg-red-500/10 border-red-500/20 text-center py-12 px-4 shadow-lg shadow-red-500/10">
                    ...
                    <h3 className="text-xl font-bold text-red-700 dark:text-red-400 mb-2">Accès restreint</h3>
                    <p className="text-[var(--foreground)]/70 text-sm mb-6 max-w-sm mx-auto">
                        Votre accès aux cours est temporairement suspendu en raison d'un retard de paiement. Veuillez régulariser votre situation depuis l'accueil pour continuer à apprendre.
                    </p>
                </div>
            </div>
        );
                            ...
                            <div className="divide-y divide-black/5 dark:divide-white/5">
                                {module.lessons.map(lesson => (
                                    <button key={lesson.id} className="w-full flex items-center justify-between p-4 hover:bg-[var(--surface-hover)] transition-colors text-left group">
                                        ...
                                        <svg className="w-4 h-4 text-[var(--foreground)]/20 group-hover:text-[var(--primary)] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
                                    </button>
                                ))}
                            </div>
                        </div>
