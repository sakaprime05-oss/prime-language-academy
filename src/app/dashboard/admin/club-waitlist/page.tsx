            ...
            <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm font-medium leading-6 text-white/50">
                        Le Club accepte {PLA_CLUB_CAPACITY} membres maximum. Quand une place est disponible, l'admin invite le premier membre et son paiement Paystack est cree cote serveur.
                    </p>
                </div>
